...
public class SignUpFragment extends BaseFragment {
    private TextInputLayout til_fname, til_lname, til_email, til_password, til_c_password, til_number;
    private Button btn_next;
    private String fname, lname, email, pass, c_pass, mobile;
...
//                    executeSignUp();
    ...
    private void executeSignUp() {
        ...
        httpParamObject.setClassType(UserApi.class);
    ...
    public void onPostExecute(Object response, int taskCode, Object... params) {
        ...
        switch (taskCode) {
            case AppConstants.TASKCODES.REGISTER:
                UserApi userApi = (UserApi) response;
                if (userApi.getError() != null) {
                    showToast(userApi.getError());
                } else {
                    Preferences.saveData(AppConstants.PREF_KEYS.USER_ID,userApi.getProfileId());
                    loginUser();
                }
                break;
